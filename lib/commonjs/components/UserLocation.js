...
class UserLocation extends _react.default.Component {
  ...
  constructor(props) {
    ...
    _locationManager.default.setCustomLocationUpdater(props.mockLocation ?? null);
  ...
  async componentDidUpdate(prevProps) {
    ...
    if (this.props.mockLocation !== prevProps.mockLocation) {
      _locationManager.default.setCustomLocationUpdater(this.props.mockLocation ?? null);
