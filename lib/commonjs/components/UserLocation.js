...
class UserLocation extends _react.default.Component {
  ...
  constructor(props) {
    ...
    _locationManager.default.setMockLocation(props.mockLocation ?? null);
  ...
  async componentDidUpdate(prevProps) {
    ...
    if (this.props.mockLocation !== prevProps.mockLocation) {
      _locationManager.default.setMockLocation(this.props.mockLocation ?? null);
      if (this.props.mockLocation) {
        this._onLocationUpdate(this.props.mockLocation ?? null);
      } else {
        this._onLocationUpdate(await _locationManager.default.getLastKnownLocation());
      }
    }
  ...
  _renderNative() {
    ...
    return /*#__PURE__*/_react.default.createElement(_LocationPuck.default, props);
  }
  render() {
    const {
      heading,
